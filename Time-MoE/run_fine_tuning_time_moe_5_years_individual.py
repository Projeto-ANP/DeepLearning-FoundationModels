...
directory = 'dataset_individual_5_years/'
year_folder = '*'  # Change to '*' to include all subdirectories
...
for model, norm, epoch, dataset_path, learning_rate in parameter_combinations:
    ...
    output_dir = f"models_fine_tuning_individual_5_years/model_{model}M/fine_tuning_{model}M_{year}_{state}_{derivative}_{epoch}_epochs_{learning_rate}/time_moe"
