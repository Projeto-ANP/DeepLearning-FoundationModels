...
directory = 'dataset_global_5_years/'
...
for model, norm, epoch, dataset, learning_rate in parameter_combinations:
    ...
    output_dir = f"models_fine_tuning_global_5_years/model_{model}M/fine_tuning_{model}M_{year}_{epoch}_epochs_{learning_rate}/time_moe"
    ...
    command = [
        "python",
        "main.py",
        "-d", f"dataset_global_5_years/{dataset}",
